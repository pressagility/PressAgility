...
function flying_pages_enqueue_scripts() {
    ...
    wp_enqueue_script('flying-pages', '/wp-content/site'.WPPA_SITE_ID.'/mu-plugins/wppa-critical-plugins/flying-pages/flying-pages.min.js', array(), FLYING_PAGES_VERSION, true);
    //wppa_patch end
