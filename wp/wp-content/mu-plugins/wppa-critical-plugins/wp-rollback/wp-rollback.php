        ...
        public function scripts( $hook ): void {
            ...
            if ( 'themes.php' === $hook && !is_multisite() ) {
                ...
                wp_enqueue_script(
                    ...
                    '/wp-content/site'.WPPA_SITE_ID.'/mu-plugins/wppa-critical-plugins/wp-rollback/build/themes.js',
                    //wppa_patch end
                ...
                wp_localize_script(
                    'wp-rollback-themes-script', 'wprData', [
                        ...
                        'logo'                  => '/wp-content/site'.WPPA_SITE_ID.'/mu-plugins/wppa-critical-plugins/wp-rollback/src/assets/logo.svg',
                        //wppa_patch end
            ...
            wp_enqueue_script(
                ...
                '/wp-content/site'.WPPA_SITE_ID.'/mu-plugins/wppa-critical-plugins/wp-rollback/build/admin.js',
                //wppa_patch end
            ...
            wp_enqueue_style(
                ...
                '/wp-content/site'.WPPA_SITE_ID.'/mu-plugins/wppa-critical-plugins/wp-rollback/build/admin.css',
                //wppa_patch end
                [ 'wp-components' ],
