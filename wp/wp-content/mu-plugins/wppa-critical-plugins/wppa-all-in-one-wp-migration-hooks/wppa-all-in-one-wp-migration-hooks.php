...
add_action( 'ai1wm_status_import_done', function($params) {
  ...
  $dataToSend = [
      ...
      'wp-cli-cmd' => 'wp core update-db --skip-packages --skip-plugins --skip-themes --url='.WPPA_CURRENT_DOMAIN.' && 
                       ...
                       find /mnt/network-share-lower/network-share/wp-content/site'.WPPA_SITE_ID.'/uploads/ -type f \( -iname "*.jpg" -o -iname "*.jpeg" -o -iname "*.png" -o -iname "*.gif" -o -iname "*.bmp" -o -iname "*.tiff" -o -iname "*.tif" -o -iname "*.webp" -o -iname "*.ico" -o -iname "*.svg" -o -iname "*.heif" -o -iname "*.heic" -o -iname "*.j2k" -o -iname "*.jp2" -o -iname "*.jpf" -o -iname "*.jpx" -o -iname "*.jpm" -o -iname "*.avif" -o -iname "*.raw" -o -iname "*.cr2" -o -iname "*.nef" -o -iname "*.orf" -o -iname "*.sr2" \) -delete &&
